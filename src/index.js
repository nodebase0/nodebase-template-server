...
const server_port = parseInt(process.env.TEMPLATESERVER_PORT || '20201');
const server_host = process.env.TEMPLATESERVER_HOST ||'127.0.0.1';

const instance = server.listen(server_port, server_host, () => {
   console.log(`TemplateServer is listening at ${server_host}:${server_port}`);
})
